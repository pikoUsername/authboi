...
async def require(request: web.Request, permission: Permissions):
...
async def authorize(request: web.Request, username, password):
...
class DummyTokenIdentityPolicy(AbstractIdentityPolicy):
    ...
    def __init__(self, server_secret=None):
        ...
        self.hmac = HMAC(key=server_secret, digestmod=sha512)
